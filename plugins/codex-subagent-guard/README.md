...
See the repository `README.md` for a copy-paste full live test prompt covering denial, inference, built-ins, TOML overrides, optional field repair, and `fork_context` config.
